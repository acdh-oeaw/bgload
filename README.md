...
`curl http://dbuser:dbpassword@varuna.arz.oeaw.ac.at:8080/dbname/sparql?context-uri=http://example.org -H 'Content-Type: application/sparql-update; charset=UTF-8' -H 'Accept: application/rdf+xml' -d@your-dump.rdf`
