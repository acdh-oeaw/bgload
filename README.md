...
**Notes**: 
* Splitting 100G large .gz file (uncompressed 1,5T) lasts 24h. After splitting each .gz compressed file is 2G large (uncompressed 30G). Import of 1 splitted file lasts 31h.
